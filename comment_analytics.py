...
with open('/home/hoangvu/Documents/hiip/pythonProject/.streamlit/secrets.toml', 'r') as f:
    config = toml.load(f)

# Modify values in the config
config["connections"]["gsheets"]['spreadsheet'] = link_ggsheet

# Write the modified config back to the file
with open('/home/hoangvu/Documents/hiip/pythonProject/.streamlit/secrets.toml', 'w') as f:
    toml.dump(config, f)
